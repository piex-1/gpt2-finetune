...
def main():
    ...
    parser.add_argument("--train_batch_size", default=32, type=int, help="Total batch size for training.")# 32
    parser.add_argument("--predict_batch_size", default=8, type=int, help="Total batch size for predictions.")
    parser.add_argument("--learning_rate", default=5e-5, type=float, help="The initial learning rate for Adam.")
    parser.add_argument("--num_train_epochs", default=2.0, type=float, # 3
    ...
    # 去除了包含 'pooler' 字符串的参数。这样的处理可能是因为在某些情况下，'pooler'参数不被使用，但可能会导致一些问题
    ...
    if args.do_train and (args.local_rank == -1 or torch.distributed.get_rank() == 0): # 3 test
